...
install -d %{buildroot}%{_datadir}/pear/%{_class}/%{_subclass}/Protocol

install %{_pearname}-%{version}/%{_subclass}/*.php %{buildroot}%{_datadir}/pear/%{_class}/%{_subclass}/
install %{_pearname}-%{version}/%{_subclass}/Protocol/*.php %{buildroot}%{_datadir}/pear/%{_class}/%{_subclass}/Protocol/
